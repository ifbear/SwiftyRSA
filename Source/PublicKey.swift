...
public extension SwiftyRSA {
    class PublicKey: Key {
        ...
        /// Takes an input string, scans for public key sections, and then returns a SwiftyRSA.PublicKey for any valid keys found
        ...
        ///
        /// - returns: An array of `SwiftyRSA.PublicKey` objects
        public static func publicKeys(pemEncoded pemString: String) -> [SwiftyRSA.PublicKey] {
            ...
            let keys = matches.compactMap { result -> SwiftyRSA.PublicKey? in
                ...
                return try? SwiftyRSA.PublicKey(pemEncoded: String(thisKey))
            }
